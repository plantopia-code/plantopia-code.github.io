...
declare namespace pxsim {
    ...
    function dumpHeap(v: any, heap: Map<any>, fields?: string[]): Variables;
    function getBreakpointMsg(s: pxsim.StackFrame, brkId: number): {
...
declare namespace pxsim {
    ...
    class FnWrapper {
        ...
        args: any[];
        cb: ResumeFn;
        constructor(func: LabelFn, caps: any[], args: any[], cb: ResumeFn);
    }
    interface VTable {
        name: string;
        methods: LabelFn[];
    ...
    namespace pxtcore {
        let incr: typeof pxsim.incr;
        let decr: typeof pxsim.decr;
...
declare namespace pxsim {
    ...
    type EventValueToActionArgs<T> = (value: T) => any[];
    class EventQueue<T> {
        runtime: Runtime;
        private valueToArgs;
        max: number;
        ...
        constructor(runtime: Runtime, valueToArgs?: EventValueToActionArgs<T>);
        push(e: T, notifyOne: boolean): Promise<void>;
        private poke();
    ...
    class Runtime {
        ...
        unregisterLiveObject(object: RefObject, keepAlive?: boolean): void;
        runningTime(): number;
