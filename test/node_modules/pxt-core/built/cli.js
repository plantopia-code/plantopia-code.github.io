...
var LOGIN_PROVIDERS = [GITHUB_KEY, CROWDIN_KEY];
...
var Host = /** @class */ (function () {
    ...
    Host.prototype.getHexInfoAsync = function (extInfo) {
        ...
        if (pxt.options.debug) {
            var compileReq = JSON.parse(new Buffer(extInfo.compileData, "base64").toString("utf8"));
...
function simshimAsync() {
    ...
    var prog = pxtc.plainTsc(path.resolve(simDir()));
...
function buildAsync(parsed) {
    ...
    return (clean ? cleanAsync() : Promise.resolve())
        .then(function () { return buildCoreAsync({ mode: mode, warnDiv: warnDiv, ignoreTests: ignoreTests }); })
        .then(function (compileOpts) { });
}
